...
export const CRYPTOS = [
  { id: "BTC", name: "Bitcoin", icon: FaBitcoin, color: "text-orange-500", gasFee: "0.0005", amount: "0.005" },
  { id: "ETH", name: "Ethereum", icon: FaEthereum, color: "text-purple-500", gasFee: "0.01", amount: "0.2" },
  { id: "USDT", name: "Tether", icon: SiTether, color: "text-green-500", gasFee: "1", amount: "300" },
